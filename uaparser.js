  ...
  var E = 500,
    ...
    Si = function (i, e) {
      if (typeof i === c && 0 < i.length) {
        for (var t in i) if (M(i[t]) == M(e)) return !0;
        return !1;
      }
    ...
    Hi = function (i, e) {
      if (H(i))
        return (i = zi(/^\s\s*/, i)), typeof e === n ? i : i.substring(0, E);
    },
    Mi = function (i, e) {
      if (i && e)
                  ...
                  typeof (r = b[o]) === c && 0 < r.length
                    ? 2 === r.length
                      ? typeof r[1] == R
                        ...
                        : (this[r[0]] = r[1])
                      : 3 === r.length
                      ? typeof r[1] !== R || (r[1].exec && r[1].test)
    ...
    Ii = {
      ...
      device: [
        ...
        [T, [x, hi], [k, S]],
        [/\b(opd2(\d{3}a?))(?: bui|\))/i],
        [T, [x, N, { OnePlus: ["304", "403", "203"], "*": hi }], [k, r]],
        ...
        [T, [x, "TCL"], [k, S]],
        [/(itel) ((\w+))/i],
        [[x, M], T, [k, N, { tablet: ["p10001l", "w7001"], "*": "mobile" }]],
          ...
          ((s.prototype.is = function (i) {
            ...
            for (e in this)
              if (
                ...
                !Si(o, e) &&
                M(r ? zi(r, this[e]) : this[e]) == M(r ? zi(r, i) : i)
              ) {
                if (((t = !0), i != n)) break;
              } else if (i == n && t) {
                t = !t;
  ...
  function Bi(i, e, t, o) {
    return (
      ...
      (this.detectFeature = function () {
        if (z && z.userAgent == this.ua)
          switch (this.itemType) {
            case u:
              z.brave && typeof z.brave.isBrave == R && this.set(v, "Brave");
              break;
            case p:
              !this.get(k) && O && O[S] && this.set(k, S),
                "Macintosh" == this.get(T) &&
                  z &&
                  typeof z.standalone !== n &&
                  z.maxTouchPoints &&
                  2 < z.maxTouchPoints &&
      ...
      (this.parseUA = function () {
        return (
          this.itemType != g && Mi.call(this.data, this.ua, this.rgxMap),
          this.itemType == u && this.set(L, Ai(this.get(y))),
          this
        );
      }),
      (this.parseCH = function () {
        ...
        switch (this.itemType) {
            ...
            if (r)
              for (var a in r) {
                ...
                this.itemType != u ||
                  ...
                  this.set(v, s).set(y, a).set(L, Ai(a)),
                  (o = s)),
          ...
          case h:
            var n = e[C];
            n && ("64" == e[K] && (n += "64"), Mi.call(this.data, n + ";", t));
            break;
          case p:
            if (
              (e[S] && this.set(k, S),
          ...
          case f:
            ...
            n &&
              ((b = e[Y]),
              n == Ci && (b = 13 <= parseInt(Ai(b), 10) ? "11" : "10"),
      ...
      this instanceof I
        ? ((r =
          ...
          j
            ...
            .setUA(r),
          this)
        : new I(i, e, t).getResult()
    );
  }
  (I.VERSION = "2.0.3"),
    (I.BROWSER = U([v, y, L, k])),
    (I.CPU = U([C])),
    (I.DEVICE = U([T, x, k, G, S, e, r, t, D])),
    (I.ENGINE = I.OS = U([v, y])),
    typeof exports !== n
      ? ((exports =
